...
public class QuestController {
    ...
    private void currentUserDailyQuestSet(@NotNull final UUID courseId,
                                          @ContextValue final LoggedInUser currentUser) {

    }

    @QueryMapping("_internal_noauth_currentUserReturningQuestSets")
    private void currentUserReturningQuestSets(@NotNull final UUID courseId,
                                               @ContextValue final LoggedInUser currentUser) {
