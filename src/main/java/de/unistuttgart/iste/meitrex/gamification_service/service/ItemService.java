...
public class ItemService {
    ...
    public ItemService(UserService userService, GoalProgressService goalProgressService, ItemInstanceRepository itemInstanceRepository, List<ItemParent> lotteryItemList) {
